    ...
    public sealed class CurtainWallBuildCommands
    {
        ...
        public void BuildCurtain3D()
        {
            ...
            try
            {
                ...
                // Native Undo must return the selected GlassWall to its exact command-entry semantic state.
                // Capture/register before regeneration because regeneration can rewrite quantities, Dirty/UpdatedUtc,
                // and project persistence revision even before the first native host/frame/panel mutation.
