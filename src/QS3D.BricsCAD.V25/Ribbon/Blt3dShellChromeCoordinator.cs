...
namespace QS3D.BricsCAD.V25.Ribbon
{
    ...
    /// taking ownership of the BricsCAD application/window icon. QS3D may hide reference-excluded
    /// application/QAT/search chrome while active, and restores all host-owned visibility values
    ...
    internal static class Blt3dShellChromeCoordinator
    {
        ...
        /// <summary>
        /// Idempotently reapplies only the QS3D-owned visibility treatment after a host
        /// Ribbon/workspace transition. BricsCAD keeps full ownership of its window/application
        /// icon; this method never changes WPF Window.Icon or native WM_SETICON state.
        /// </summary>
