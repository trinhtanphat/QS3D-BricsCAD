...
namespace QS3D.BricsCAD.V25.Ribbon
{
    internal static class RibbonBootstrapper
    {
        ...
        {
            yield return new RibbonTabSpec("QS3D_HOME", "KHỞI ĐẦU", new RibbonButtonSpec("QS3D", "QS3D"), new RibbonButtonSpec("Lưu", "QS3DSAVE"), new RibbonButtonSpec("BQ", "QS3DBQ"), new RibbonButtonSpec("Health", "QS3DHEALTH"));
            ...
            yield return new RibbonTabSpec("QS3D_BIM", "MÔ HÌNH BIM", new RibbonButtonSpec("Phòng", "QS3DROOM"), new RibbonButtonSpec("Tường KT", "QS3DWALL"), new RibbonButtonSpec("Lỗ mở", "QS3DOPENING"), new RibbonButtonSpec("Cửa", "QS3DDOOR"), new RibbonButtonSpec("Link Host", "QS3DLINKHOST"), new RibbonButtonSpec("HT_Phòng", "QS3DFINISH"));
            ...
            yield return new RibbonTabSpec("QS3D_TOOL", "TOOL", new RibbonButtonSpec("Inspect", "QS3DINSPECT"), new RibbonButtonSpec("Locate", "QS3DLOCATE"), new RibbonButtonSpec("Health", "QS3DHEALTH"));
            yield return new RibbonTabSpec("QS3D_MODELING", "MODELING", new RibbonButtonSpec("Tường KT", "QS3DWALL"), new RibbonButtonSpec("Phòng", "QS3DROOM"), new RibbonButtonSpec("Cửa", "QS3DDOOR"));
            ...
            yield return new RibbonTabSpec("QS3D_QTY", "ĐỊNH LƯỢNG", new RibbonButtonSpec("BQ", "QS3DBQ"), new RibbonButtonSpec("Takeoff", "QS3DTAKEOFF"), new RibbonButtonSpec("Excel", "QS3DBQ"));
