    ...
    internal static class RibbonBootstrapper
    {
        ...
        public static bool TryInitialize()
        {
            ...
            try
            {
                ...
                {
                    if (CollectionContainsId(tabs, spec.Id)) continue;
                    var tab = Create("Bricscad.Windows.RibbonTab"); SetProperty(tab, "Id", spec.Id); SetProperty(tab, "Name", spec.Id); SetProperty(tab, "Title", spec.Title); var panels = GetProperty(tab, "Panels") ?? throw new InvalidOperationException("RibbonTab.Panels was not available.");
        ...
        {
            yield return new RibbonTabSpec("QS3D_HOME", "KHỞI ĐẦU", new RibbonButtonSpec("QS3D", "QS3D"), new RibbonButtonSpec("Lưu", "QS3DSAVE"), new RibbonButtonSpec("Regenerate", "QS3DREGEN"), new RibbonButtonSpec("BQ", "QS3DBQ"), new RibbonButtonSpec("BBS", "QS3DBBS"), new RibbonButtonSpec("Health", "QS3DHEALTH"));
            ...
            yield return new RibbonTabSpec("QS3D_BIM", "MÔ HÌNH BIM",
                new RibbonButtonSpec("Phòng", "QS3DROOM"), new RibbonButtonSpec("Tường KT", "QS3DWALL"), new RibbonButtonSpec("Dầm", "QS3DBEAM"), new RibbonButtonSpec("Sàn", "QS3DSLAB"), new RibbonButtonSpec("Cột", "QS3DCOLUMN"), new RibbonButtonSpec("Vách BTCT", "QS3DSTRUCTWALL"), new RibbonButtonSpec("Móng", "QS3DFOUNDATION"), new RibbonButtonSpec("Cầu thang", "QS3DSTAIR"), new RibbonButtonSpec("Lan can", "QS3DRAILING"), new RibbonButtonSpec("Đào đất", "QS3DEARTHWORK"),
                new RibbonButtonSpec("Lỗ mở", "QS3DOPENING"), new RibbonButtonSpec("Cửa", "QS3DDOOR"), new RibbonButtonSpec("Link Host", "QS3DLINKHOST"), new RibbonButtonSpec("HT_Phòng", "QS3DFINISH"));
            yield return new RibbonTabSpec("QS3D_RECOGNIZE", "NHẬN DẠNG", new RibbonButtonSpec("Quick Takeoff", "QS3DTAKEOFF"), new RibbonButtonSpec("Inspect", "QS3DINSPECT"));
            yield return new RibbonTabSpec("QS3D_DRAW", "VẼ", new RibbonButtonSpec("Đường", "_LINE"), new RibbonButtonSpec("Cung", "_ARC"), new RibbonButtonSpec("Chữ nhật", "_RECTANG"), new RibbonButtonSpec("Di chuyển", "_MOVE"), new RibbonButtonSpec("Xoay", "_ROTATE"), new RibbonButtonSpec("Đối xứng", "_MIRROR"), new RibbonButtonSpec("Sao chép", "_COPY"), new RibbonButtonSpec("Khoảng cách", "_DIST"));
            yield return new RibbonTabSpec("QS3D_TOOL", "TOOL", new RibbonButtonSpec("Inspect", "QS3DINSPECT"), new RibbonButtonSpec("Locate", "QS3DLOCATE"), new RibbonButtonSpec("Regenerate", "QS3DREGEN"), new RibbonButtonSpec("Health", "QS3DHEALTH"));
            yield return new RibbonTabSpec("QS3D_MODELING", "MODELING", new RibbonButtonSpec("Tường KT", "QS3DWALL"), new RibbonButtonSpec("Dầm", "QS3DBEAM"), new RibbonButtonSpec("Sàn", "QS3DSLAB"), new RibbonButtonSpec("Cột", "QS3DCOLUMN"), new RibbonButtonSpec("Vách", "QS3DSTRUCTWALL"), new RibbonButtonSpec("Móng", "QS3DFOUNDATION"), new RibbonButtonSpec("Phòng", "QS3DROOM"), new RibbonButtonSpec("Cửa", "QS3DDOOR"));
            yield return new RibbonTabSpec("QS3D_VIEW", "XEM", new RibbonButtonSpec("Workspace", "QS3D"), new RibbonButtonSpec("BQ", "QS3DBQ"), new RibbonButtonSpec("Refresh", "QS3DREFRESH"));
            yield return new RibbonTabSpec("QS3D_QTY", "ĐỊNH LƯỢNG", new RibbonButtonSpec("Regenerate", "QS3DREGEN"), new RibbonButtonSpec("BQ", "QS3DBQ"), new RibbonButtonSpec("Takeoff", "QS3DTAKEOFF"), new RibbonButtonSpec("BBS", "QS3DBBS"), new RibbonButtonSpec("Excel", "QS3DBQ"));
            yield return new RibbonTabSpec("QS3D_REV", "BẢN SỬA ĐỔI", new RibbonButtonSpec("Health", "QS3DHEALTH"), new RibbonButtonSpec("Lưu", "QS3DSAVE"));
        }
        private static object? FindRibbonControl()
        {
            var servicesType = Type.GetType("Bricscad.Ribbon.RibbonServices, " + AssemblyName, false); if (servicesType == null) return null; var paletteProperty = servicesType.GetProperty("RibbonPaletteSet", BindingFlags.Public | BindingFlags.Static); var palette = paletteProperty?.GetValue(null, null);
            ...
            if (palette == null) return null; if (palette.GetType().Name == "RibbonControl") return palette; var direct = GetProperty(palette, "RibbonControl"); if (direct != null) return direct;
            foreach (var property in palette.GetType().GetProperties(BindingFlags.Instance | BindingFlags.Public)) { if (property.PropertyType.Name != "RibbonControl" || property.GetIndexParameters().Length != 0) continue; var value = property.GetValue(palette, null); if (value != null) return value; } return null;
        }
