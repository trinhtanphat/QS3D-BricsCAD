...
namespace QS3D.BricsCAD.V25.Ribbon
{
    ...
    /// Existing recognition/review command routing is preserved; this class is presentation-only.
    /// </summary>
    internal static class BltRecognitionRibbonAugmenter
    {
        ...
        public static bool TryInitialize()
        {
            ...
            try
            {
                ...
                // Reference layout: three compact rows on the left and one top-row item
                // on the right. Disabled states intentionally mirror the supplied BLT3D screenshot.
                AddPanel(
                    panels,
                    RecognitionPanelSourceId,
                    "Nhận dạng",
                    new[]
                    {
        ...
        private static void AddPanel(
            ...
            string sourceId,
            string title,
            RecognitionButtonSpec[] leftColumn,
            RecognitionButtonSpec[] rightColumn)
        {
        ...
        private static object CreateColumn(string id, RecognitionButtonSpec[] specs)
        {
            ...
            SetProperty(column, "Id", id);
            var items = GetProperty(column, "Items")
        ...
        private static object CreateButton(RecognitionButtonSpec spec)
        {
            ...
            SetProperty(button, "IsEnabled", spec.Enabled);
            ...
            if (spec.Enabled && !string.IsNullOrWhiteSpace(spec.Command))
            {
                ...
                SetProperty(button, "CommandHandler", new RecognitionRibbonCommandHandler());
            }
        ...
        private static ImageSource CreateIcon(IconKind kind)
        {
            ...
            switch (kind)
            {
                case IconKind.Restore:
                    ...
                    group.Children.Add(Stroke(light, 2.0, Geometry.Parse("M12,27 C18,30 26,26 27,19")));
                    break;

                case IconKind.Text:
                    group.Children.Add(Stroke(accentDark, 2.4, Geometry.Parse("M8,26 L15,6 17,6 24,26 M11,18 L21,18")));
                    group.Children.Add(Fill(light, new RectangleGeometry(new System.Windows.Rect(4, 4, 5, 5), 1, 1)));
                    break;
                ...
                case IconKind.Options:
                    ...
                    group.Children.Add(Stroke(light, 1.8, new LineGeometry(new System.Windows.Point(19, 21), new System.Windows.Point(24, 21))));
                    break;
                ...
                case IconKind.Table:
                    ...
                    group.Children.Add(Stroke(accent, 1.5, new LineGeometry(new System.Windows.Point(21, 7), new System.Windows.Point(21, 25))));
                    break;

                case IconKind.Boundary:
                    group.Children.Add(Stroke(accent, 2.5, Geometry.Parse("M5,9 L14,5 27,11 24,25 10,27 4,18 Z")));
                    group.Children.Add(Fill(accentDark, new System.Windows.Media.EllipseGeometry(new System.Windows.Point(5, 9), 2.2, 2.2)));
                    group.Children.Add(Fill(warning, new System.Windows.Media.EllipseGeometry(new System.Windows.Point(24, 25), 2.2, 2.2)));
                    break;

                case IconKind.Label:
                    group.Children.Add(Fill(accent, Geometry.Parse("M5,8 L18,8 27,16 18,24 5,24 Z")));
                    group.Children.Add(Fill(ink, new System.Windows.Media.EllipseGeometry(new System.Windows.Point(10, 16), 2.2, 2.2)));
                    group.Children.Add(Stroke(light, 1.6, new LineGeometry(new System.Windows.Point(15, 13), new System.Windows.Point(21, 16))));
                    break;
                ...
                case IconKind.Auto:
                    ...
                    group.Children.Add(Fill(amber, Geometry.Parse("M25,3 L27,8 31,10 27,12 25,17 23,12 19,10 23,8 Z")));
                    break;
                ...
                case IconKind.Validate:
                    ...
                    group.Children.Add(Fill(warning, new System.Windows.Media.EllipseGeometry(new System.Windows.Point(26, 7), 3.0, 3.0)));
                    break;
            }
        ...
        private static void SetEnumProperty(object target, string name, string enumValue)
        {
            ...
            {
                // BricsCAD versions can expose different enum values; text/image remain valid.
            }
        }
