...
namespace QS3D.BricsCAD.V25.Cad
{
    internal static class WallPierProfileSolidBuilder
    {
        ...
        public static int BuildSelectedLinePiers(Document document, ProjectState project)
        {
            ...
            using (var transaction = document.Database.TransactionManager.StartTransaction())
            {
                ...
                foreach (var id in ids)
                {
                    ...
                    try
                    {
                        ...
                        var previous = GeneratedGeometryService.PrepareReplacement(document, transaction, element);
            ...
            {
                GeneratedGeometryService.CommitReplacement(update.Element, update.PreviousHandle, update.GeneratedHandle, ElementCategory.WallPier);
