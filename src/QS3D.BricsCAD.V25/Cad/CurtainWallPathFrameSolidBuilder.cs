        ...
        public static CurtainFrameBuildResult BuildSelectedOpenPolylines(Document document, ProjectState project)
        {
            ...
            try
            {
                ...
                using (var transaction = document.Database.TransactionManager.StartTransaction())
                {
                    ...
                    // Keep semantic ownership/fingerprint/audit publication inside the CAD rollback
                    // window. If project publication fails, the transaction aborts; if CAD commit
                    // fails after project mutation, the outer project snapshot restores semantic state.
            ...
            catch (Exception operationError)
            {
                ...
                catch (Exception restoreError)
                {
                    throw new InvalidOperationException(
                        "Curtain path-frame rebuild thất bại và project rollback không hoàn tất.",
