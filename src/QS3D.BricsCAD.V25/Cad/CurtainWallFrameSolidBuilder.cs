    ...
    internal static class CurtainWallFrameSolidBuilder
    {
        ...
        public static CurtainFrameBuildResult BuildSelectedLineWalls(Document document, ProjectState project)
        {
            ...
            catch (Exception operationError)
            {
                ...
                {
                    throw new InvalidOperationException("Curtain LINE frame replacement failed and semantic rollback also failed.", new AggregateException(operationError, restoreError));
                }
                throw;
            }
