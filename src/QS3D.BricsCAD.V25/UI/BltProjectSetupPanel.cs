...
{
    /// <summary>
    /// Minimal owner-reference Project Information canvas. It stays presentation-only:
    ...
    {
        public const string ProjectInformationPlaceholderText =
        ...
        public BltProjectSetupPanel()
        {
            ...
            {
                Text = ProjectInformationPlaceholderText,
        ...
        {
            _placeholder.Text = ProjectInformationPlaceholderText;
        }
    }
}
