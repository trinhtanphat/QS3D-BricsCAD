...
namespace QS3D.BricsCAD.V25.UI.ViewModels
{
    ...
    {
        private bool _isVisible; public string Name { get; set; } = string.Empty; public short ColorIndex { get; set; }
    ...
    public sealed class RightPanelViewModel : INotifyPropertyChanged
    {
        ...
        public ObservableCollection<LayerItemViewModel> Layers { get; } = new ObservableCollection<LayerItemViewModel>(); public ObservableCollection<DrawingItemViewModel> Drawings { get; } = new ObservableCollection<DrawingItemViewModel>();
