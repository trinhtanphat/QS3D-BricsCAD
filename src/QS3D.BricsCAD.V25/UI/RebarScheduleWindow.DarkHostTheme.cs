...
{
    public partial class RebarScheduleWindow
    {
        ...
        {
            EventManager.RegisterClassHandler(typeof(RebarScheduleWindow), FrameworkElement.LoadedEvent,
        ...
        {
            if (sender is RebarScheduleWindow window) window.ApplyDarkHostTheme();
        }
