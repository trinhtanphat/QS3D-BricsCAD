...
{
    public partial class DoorOpeningScheduleWindow
    {
        ...
        {
            EventManager.RegisterClassHandler(typeof(DoorOpeningScheduleWindow), FrameworkElement.LoadedEvent,
        ...
        {
            if (sender is DoorOpeningScheduleWindow window) window.ApplyDarkHostTheme();
        }
