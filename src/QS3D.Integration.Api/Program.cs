...
public interface IIntegrationReadStore
{
    ...
    QuantityItem? GetQuantity(string id); BoqItem? GetBoq(string id); ClassificationRef? GetClassification(string id);
...
public sealed class EmptyIntegrationReadStore : IIntegrationReadStore
{
    ...
    public QuantityItem? GetQuantity(string id) => null; public BoqItem? GetBoq(string id) => null; public ClassificationRef? GetClassification(string id) => null;
