    ...
    public static class RoomFinishInteractionProfiles
    {
        ...
        private static FeatureDescriptor CreateFloorFinish()
        {
            var profile = new InteractionProfile(
                ...
                FeatureCapability.Create | FeatureCapability.EditParameters | FeatureCapability.Material | FeatureCapability.Geometry3D | FeatureCapability.Quantity | FeatureCapability.Regenerate,
                allowsModal: true,
