...
namespace QS3D.Core.Export
{
    ...
    /// <summary>
    /// Canonical registry for portable semantic references stored inside Element.Properties.
    ///
    /// Direct ProjectElement FamilyId/FloorId/ZoneId and DependsOn remain first-class fields and are
    /// handled separately. This registry only covers property-carried semantic identities that can be
    /// remapped without guessing or importing CAD ownership.
    /// </summary>
