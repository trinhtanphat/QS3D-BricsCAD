...
15. `docs/REMAINING-ISSUE-INDEX-2026-08-10.md` — **compact GitHub issue map for remaining runtime, BLT-authoring, geometry, engineering, documentation, performance and release gaps**;
