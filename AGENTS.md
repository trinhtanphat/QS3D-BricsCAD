...
15. `docs/LOCAL-AGENT-OPEN-WORK-ADDENDUM-2026-08-10.md` — **whole-command Curtain recovery, native DrawJig/repeated authoring, commercial-license policy/wiring, legal distribution and performance/UX gates**;
