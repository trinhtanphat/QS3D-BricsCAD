...
<<<<<<< HEAD
        "ReferenceEquals(",
        "SemanticSelectionResolver.ResolveImplied(_document, project)", "ProjectFloorService.Create", "ProjectFloorService.Update",
        "ProjectFloorService.Delete", "ProjectFloorService.SetActive", "ProjectFloorService.Assign", "ProjectFloorService.ReferenceCount",
...
>>>>>>> origin/main
    ...
    "tests/QS3D.Core.SmokeTests/ProjectFloorServiceSmoke.cs": [
        "CreateUpdateAssignAndDelete", "ElevationChangeMarksGeneratedGeometryStale",
        "DeleteGuardsActiveAndReferencedFloors", "RejectsDuplicateNamesAndInvalidElevation",
    ],
    "tests/QS3D.Core.SmokeTests/ProjectFloorServiceRegistration.cs": ["ProjectFloorServiceSmoke.Run();"],
}
