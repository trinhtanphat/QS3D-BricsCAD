...
if RUNNER.is_file():
    ...
    if (
        ...
        or '"QS3DCURTAINP11SELECT","_.UNDO","_M","QS3DCURTAIN3D","P",""' not in compact
        or '"QS3DCURTAINP11BASELINE","_.UNDO","_B","QS3DCURTAINP11CHECKUNDO","_.REDO","QS3DCURTAINP11CHECKREDO"' not in compact
    ):
