...
if errors:
    ...
    sys.exit(1)
print("PASS: native Grid annotation has explicit semantic labels, generated ownership, replacement guards, persisted + live health integration and cross-layer rollback; runtime remains separately qualified.")
