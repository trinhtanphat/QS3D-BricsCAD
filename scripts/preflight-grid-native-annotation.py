...
if errors:
    ...
    sys.exit(1)
print("PASS: native Grid annotation has explicit semantic labels, source-plane-aware geometry, generated ownership, replacement guards, persisted + live health integration and cross-layer rollback; runtime remains separately qualified.")
