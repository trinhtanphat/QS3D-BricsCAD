...
def validate(text: str) -> list[str]:
    ...
    zip_validation = text.find("Assert-ZipPayloadMatchesSignedStaging")
...
print("PASS: V25 update-manifest metadata, signed staging, and ZIP inputs remain bound to stable ordinary-file generations across trust and identity consumption.")
