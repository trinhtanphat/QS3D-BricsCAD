...
def main():
    ...
    require(planner, "!FitsWithin(placement.Xmm, placement.WidthMm, sheet.WidthMm)", "overflow-safe existing view horizontal paper-bound guard", failures)
    require(planner, "!FitsWithin(placement.Ymm, placement.HeightMm, sheet.HeightMm)", "overflow-safe existing view vertical paper-bound guard", failures)
    require(planner, "private static bool FitsWithin(double start, double extent, double limit)", "overflow-safe paper-bound helper", failures)
