...
def main() -> int:
    ...
    required = {
        ...
        "toast timer handler storage": "TimerHandler",
        "toast timer handler detach": "visual.Timer.Tick -= visual.TimerHandler",
        "toast clear through dismiss": "foreach (var visual in new List<ToastVisual>(_visibleToasts)) DismissToast(visual)",
