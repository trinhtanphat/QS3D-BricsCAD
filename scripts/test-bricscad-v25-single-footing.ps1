...
$candidates = @{
    ...
    'e1c2cea395db11365bdba6f113a5ba7583e88cc3' = @{
    ...
    'bb8f442d13bfc2f6cbc21bf1e0a549fd760c1608' = @{
        PackageSha256 = '918507aea148f1f784abf9c6729e8a64250948f3c74352d083f5286fcb50109f'
