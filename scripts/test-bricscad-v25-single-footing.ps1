...
$candidates = @{
    'af6c585190efb80581e286add7027540e7cc7c52' = @{
        PackageSha256 = '039c0db69bf735ff3811cfbfb8dddfcc67deaaf87fa4c8bf8d29c189bc206b21'
        ProductVersion = '0.1.0-preview.10308'; Kind = 'LOCAL_PR_CANDIDATE'
    }
    ...
    'f0146aacef0b398bc71e8e278e6f7675432c1f17' = @{
        PackageSha256 = 'ee1f820baaa93d1b5e636432e317ca76c632b856480450467449af249c2636c0'
        ProductVersion = '0.1.0-preview.10307'; Kind = 'LOCAL_PR_CANDIDATE'
    }
    ...
    'd5e5e3851125b279bc6807074a34f8de2700cef5' = @{
        PackageSha256 = 'e27d645b88af709369ac8c04b96fff43b8c688496b8908694825b7491efc2633'
        ProductVersion = '0.2.0-preview.14'; Kind = 'LOCAL_PR_CANDIDATE'
    }
}
...
function Read-Phase([string]$Phase) {
    ...
    if ($marker.schema -cne 'QS3D_LOCAL022_NATIVE_V3' -or $marker.run_id -cne $runId -or $marker.phase -cne $Phase) {
...
$envNames = @('QS3D_LOCAL022_RUN_ID', 'QS3D_LOCAL022_ROOT', 'QS3D_LOCAL022_DRAWING', 'QS3D_LOCAL022_PRODUCT_DLL',
    'QS3D_LOCAL022_PROBE_DLL', 'QS3D_LOCAL022_PHASE', 'QS3D_LOCAL022_UI_DRIVER', 'QS3D_LOCAL022_PAUSE_FOR_OPERATOR', 'QS3D_LOCAL022_RENDER_EXPERIMENT')
$envBefore = @{}
