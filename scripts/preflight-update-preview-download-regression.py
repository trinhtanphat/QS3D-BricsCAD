...
class PreviewDownloadGuardMutationTests(unittest.TestCase):
    ...
    def test_transport_integrity_and_staging_mutations_are_rejected(self):
        cases = (
            ...
            (DOWNLOADER, "request.Timeout = NetworkTimeoutMilliseconds;", "request.Timeout = -1;"),
            (DOWNLOADER, "request.ReadWriteTimeout = NetworkTimeoutMilliseconds;", "request.ReadWriteTimeout = -1;"),
            ...
            (DOWNLOADER, "EnsureAllowedUri(response.ResponseUri);", "/* mutation removed final response URI validation */"),
