...
checks = {
    ...
    required[3]: ['CommandMethod("QS3DFAMILIES"', "new FamilyManagerWindow(document)", "ShowModelessWindow"],
    required[4]: [
        "PropertyUpdatesPreserveOverrides", "FamilyAssignmentDropsOldInheritedDefaultsButKeepsOverrides", "DuplicateRenameDeleteGuards",
        "IsGeneratedSolidStale()", "Explicit instance override did not survive Family assignment",
    ],
    required[5]: ["ProjectFamilyServiceSmoke.Run();"],
}
...
if errors:
    ...
    sys.exit(1)
print("PASS: inheritance-safe Family CRUD/properties/assignment, override preservation, reference guards and document-bound Family Manager are present.")
