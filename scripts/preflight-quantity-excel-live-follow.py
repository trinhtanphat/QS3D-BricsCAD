...
def main():
    ...
    forbid(active, "Activator.CreateInstance", "must not launch Excel via COM activation", failures)
    forbid(active, "Type.GetTypeFromProgID", "must not create an Excel application from its ProgID", failures)
