...
interactive_cases = (
    ...
    (ADAPTER / "FoundationMeshCommands.cs", "public void BuildFoundationMesh3D()", "private static void FinalizeUi", "Foundation Mesh", "ExistingProjectMutationContext.Require(document, \"Foundation Rebar 3D\")", "FoundationMeshSolidBuilder.BuildSelected(document, project, selectedIds)"),
