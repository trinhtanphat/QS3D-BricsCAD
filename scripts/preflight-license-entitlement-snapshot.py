...
print("PASS: entitlement snapshots are bounded, canonical, UTC-normalized, and fail closed when persisted content is malformed or modified without its matching integrity seal.")
