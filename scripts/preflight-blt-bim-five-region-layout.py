...
print("PASS: explicit BIM mode shows Model + dedicated QS3D Properties + native BricsCAD viewport + Management + Quantity regions, reports settle success/failure, preserves isolated commands, and reapplies deterministic left/right docking after palette recreation.")
