...
print("PASS: finite LINE/ARC Grid intersections are bounded, their smoke is registered, and ambiguous overlap/coincident support fails closed while native extraction, ordering, constraints and visualization remain explicit V25 gates.")
