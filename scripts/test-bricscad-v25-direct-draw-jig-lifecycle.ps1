...
Write-Host '  8. Confirm marker starts QS3D_DIRECT_DRAW_JIG_RUNTIME_V1 and persistent_writes=0.'
Write-Host '  9. Repeat with a rotated UCS and after switching back to WCS; active-document changes must fail closed.'
Write-Host ''
