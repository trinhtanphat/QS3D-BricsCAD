...
Write-Host '  8. Confirm marker starts QS3D_DIRECT_DRAW_JIG_RUNTIME_V1, coordinate_model=WCS_INPUT_UCS_PLANE and persistent_writes=0.'
Write-Host '  9. Repeat under a rotated or translated UCS and confirm the preview remains anchored to the picked cursor points; switching active documents must fail closed.'
