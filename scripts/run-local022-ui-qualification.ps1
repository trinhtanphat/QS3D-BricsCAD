...
try {
    ...
    $parameters = @{
        ...
        PackageSha256 = if ($HostMajor -eq 25) { '4d9869e38682674772196a3e238f115624ff357a276bb0b976000b63c9a833b5' } else { '7dbf9216e873f2e20c2fae5011785148e9feded944a7b43233b4710b331fd2c5' }
