...
try {
    ...
    $parameters = @{
        ...
        PackageSha256 = if ($HostMajor -eq 25) { '6da38fcb3bc5fdb1989e9397fad45da712bf4af6b7690298a2fe83657bcb10ac' } else { '59498948341f36d408f8bf838e177170c19d99ffc64acaa2070b0524e6b99a81' }
