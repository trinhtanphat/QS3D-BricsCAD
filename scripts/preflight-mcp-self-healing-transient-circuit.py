...
required = [
    ...
    "var circuitOpen = fatalNativeFailure || ((sourceRepairEligible || transientFailure)",
...
fatal_index = text.index("var fatalNativeFailure")
...
if not (caller_index < fatal_index < transient_index < source_index < circuit_index < human_index < retry_index):
