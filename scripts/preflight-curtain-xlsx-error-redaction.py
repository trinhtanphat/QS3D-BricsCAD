...
if not SOURCE.is_file():
    ...
    required = (
        ...
        'QuantityReportMath.Add(glass, row.NetGlassAreaM2, "Curtain export net glass area")',
        'QuantityReportMath.Add(frame, row.FrameLengthM, "Curtain export frame length")',
