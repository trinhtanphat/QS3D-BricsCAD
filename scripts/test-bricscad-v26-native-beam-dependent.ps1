...
$runner = Join-Path $PSScriptRoot "test-bricscad-v25-source-reconcile-native-beam-dependent.ps1"
if (-not (Test-Path -LiteralPath $runner -PathType Leaf)) {
    throw "The shared native Beam dependent-output runner is missing."
}
...
if (-not $?) { throw "The BricsCAD V26 native Beam dependent-output runner failed." }
