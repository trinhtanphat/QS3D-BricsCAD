...
print("PASS: BIM activation reasserts separate Model/Family, QS3D Properties, Management and Quantity native palettes through the bounded docking-settle window, preserves retries across transient failures, and keeps native BricsCAD modelspace.")
