...
print("PASS: Recognition/BQ/BBS/Revision/Health modeless actions stay bound to their source DWG; Recognition surfaces atomic batch failures, BQ refreshes before export, and BBS totals use canonical compensated checked aggregation.")
