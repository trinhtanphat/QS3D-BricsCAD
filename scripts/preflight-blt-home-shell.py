...
def main():
    ...
    print("PASS: QS3D Home and Start Center use native WPF Button.Click hit targets, unique panels, branded/rasterized icons and direct mouse-first project actions; Create New explicitly seeds the canonical project, while Save/Save As preserve existing-project and verified sidecar-transition safety.")
    return 0
