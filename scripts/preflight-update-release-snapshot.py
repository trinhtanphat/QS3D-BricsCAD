...
def main() -> int:
    ...
    require(text, "function Invoke-BoundedHttpsDownload", "bounded HTTPS download helper")
    ...
    manifest_download = text.find("Invoke-BoundedHttpsDownload -Address $manifestAddress", snapshot_parse)
    ...
    for needle in (
        ...
        "-MaxBytes 65536 -TimeoutMilliseconds 30000 -Label 'Update manifest'",
        "-MaxBytes $maxBytes -TimeoutMilliseconds 120000 -Label 'Update package'",
    ):
        require(text, needle, "official URL/download identity guard")
