...
if runner.is_file():
    ...
    required = (
        ...
        "FULL INTERACTIVE/PRIVATE-DWG PRODUCT MATRIX: NOT RUN",
    )
...
print("PASS: local V25 work is exact-SHA/clean-tree gated, runs source/Core/adapter/WPF/runtime smoke checks without claiming the full interactive matrix, records local evidence outside Git, and keeps unresolved runtime/product work explicitly routed without weakening manual-only CI policy.")
