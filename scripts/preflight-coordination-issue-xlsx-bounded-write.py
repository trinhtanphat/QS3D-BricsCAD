...
if "private static string BuildSheet(" in text or "var builder = new StringBuilder();" in text:
...
if missing:
    raise SystemExit(
        "ERROR: Coordination Issue XLSX export remains unbounded before package validation:\n - "
        + "\n - ".join(missing)
    )

print("PASS: Coordination Issue XLSX writer is bounded before package materialization")
