...
if not errors:
    ...
    for token in (
        ...
        "AttachThreadInput($runnerThreadId, $foregroundThreadId, $true)",
        "AttachThreadInput($runnerThreadId, $foregroundThreadId, $false)",
        "$foregroundThreadId -ne $windowThreadId",
        "keybd_event(0x1B",
        ...
        "Assert-V26InstalledDesktopRuntime",
        ...
        "DOTNET_ROOT alone is insufficient",
        "-WindowStyle Hidden",
        '"QS3DSAVE"',
        '"_.QSAVE"',
