...
& (Join-Path $PSScriptRoot '..\tests\QS3D.LocalQualification.V25\test-native-api-wrapper.ps1')
& (Join-Path $PSScriptRoot '..\tests\QS3D.LocalQualification.V25\diagnostics\test-diagnostic-guards.ps1')
& (Join-Path $PSScriptRoot '..\tests\QS3D.LocalQualification.V25\test-ui-view-projection.ps1')
& (Join-Path $PSScriptRoot '..\tests\QS3D.LocalQualification.V25\test-ui-render-diagnostics.ps1')
& (Join-Path $PSScriptRoot '..\tests\QS3D.LocalQualification.V25\test-ui-render-experiment.ps1')
& (Join-Path $PSScriptRoot '..\tests\QS3D.LocalQualification.V25\test-ui-render-controls.ps1')
& (Join-Path $PSScriptRoot '..\tests\QS3D.LocalQualification.V25\test-native-sections.ps1')
& (Join-Path $PSScriptRoot '..\tests\QS3D.LocalQualification.V25\test-native-brep.ps1')
& (Join-Path $PSScriptRoot '..\tests\QS3D.LocalQualification.V25\test-quantity-ui.ps1')
