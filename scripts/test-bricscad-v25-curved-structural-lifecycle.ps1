...
try {
    ...
    $session1 = @(
        ...
        "NETLOAD",('"'+$PluginDll+'"'),
        "QS3DCURVEDLIFEPREPARE","QS3DCURVEDLIFESELECTBEAMS","QS3DBUILD3D",
        "QS3DCURVEDLIFESELECTSLAB","QS3DBUILD3D","QS3DCURVEDLIFECAPTUREBASELINE",
        "_.U","_.U","QS3DCURVEDLIFECHECKUNDO","_.REDO","_.REDO","QS3DCURVEDLIFECAPTUREREDO","QS3DCURVEDLIFECHECKREDO",
