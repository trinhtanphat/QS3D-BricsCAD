...
checks = {
    ...
    "src/QS3D.Core/Diagnostics/GeneratedHandleOwnershipPolicy.cs": [
        "RebarHandleKeys", "GeneratedTieRebarHandles", "IsOwnerSlot", "IsRebarOwnerSlot"
    ],
    "src/QS3D.BricsCAD.V25/Cad/CadGeometryGuard.cs": [
    ...
    "src/QS3D.BricsCAD.V25/Cad/GeneratedTieRebarOwnershipGuard.cs": [
        ...
        "GeneratedTieRebarHandles", "EnsureTieOwned", "Refusing destructive erase"
    ],
    "src/QS3D.BricsCAD.V25/Cad/ColumnTieSolidBuilder.cs": [
        ...
        "CadGeometryGuard.Midpoint", "CadGeometryGuard.Subtract", "CadGeometryGuard.Multiply", "CadGeometryGuard.Hypot3",
        "MaxTiesPerBatch - layout.ElevationsM.Count"
    ],
    "tests/QS3D.Core.SmokeTests/ColumnTieLayoutSmoke.cs": [
        "SpacingIsMaximumNotMinimum", "SingleTieWhenUsableRangeCollapses", "RejectsImpossibleCoverAndBadSpacing", "PathPerimeterM"
    ],
    "tests/QS3D.Core.SmokeTests/GeneratedTieHealthSmoke.cs": [
...
print("PASS: rectangular column tie planning, bounded native geometry, finite CAD transforms, policy-driven destructive ownership, health and deterministic smoke registration are present.")
