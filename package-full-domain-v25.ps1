...
The package intentionally excludes BricsCAD runtime assemblies.
Recognition suggestions with low confidence require human review.
Structural Solid3d paths require the V25 runtime gate before release qualification.
