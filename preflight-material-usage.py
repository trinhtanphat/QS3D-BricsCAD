...
<<<<<<< HEAD
        "must be finite and non-negative", "private static double QFirst", "element.Quantities.ContainsKey(key)",
=======
...
<<<<<<< HEAD
        ...
        "RoomFinishQuantityPriorityMatchesFinishSchedule", "14.4d", "33d", "22d",
=======
