...
{
    internal static class AdvancedCostNegativeKnownCountSmoke
    {
        ...
        {
            var source = new NegativeGenericCount<CostResourceComponent>();
            var error = Capture<InvalidOperationException>(() => BuildUp("NEGATIVE-GENERIC", source));
        ...
        {
            var source = new NegativeReadOnlyCount<CostResourceComponent>();
            var error = Capture<InvalidOperationException>(() => BuildUp("NEGATIVE-READONLY", source));
        ...
        {
            var source = new NegativeNonGenericCount<CostResourceComponent>();
            var error = Capture<InvalidOperationException>(() => BuildUp("NEGATIVE-NONGENERIC", source));
    ...
    internal static class AdvancedCostNegativeKnownCountRegistration
    {
        [ModuleInitializer]
        internal static void Initialize()
        {
            AdvancedCostNegativeKnownCountSmoke.Run();
        }
    }
}
