...
namespace QS3D.Core.SmokeTests
{
    internal static class PolylineLengthCompensationSmoke
    {
        ...
        private static void PreservesFourSmallSegmentsAfterHugeSegment()
        {
            ...
            Exact(10000000000000004d, PolylineMetrics.Length(points, closed: false), "four unit segments accumulated after a huge segment");
        }
        ...
        private static void DuplicateClosingVertexRemainsCanonical()
        {
            ...
            Exact(12d, PolylineMetrics.Length(points, closed: false), "explicitly closed point sequence");
            Exact(12d, PolylineMetrics.Length(points, closed: true), "explicitly closed point sequence with zero closing segment");
        }
