...
namespace QS3D.Core.SmokeTests
{
    internal static class ProjectInterchangeImportPreviewSmoke
    {
        ...
        private static void FingerprintRelationIsDescriptive()
        {
            ...
            Equal(InterchangeDrawingFingerprintRelation.Unknown, ProjectInterchangeImportPreview.Plan(new ProjectState("target", "T") { DrawingFingerprint = "   " }, json).DrawingFingerprintRelation);
        }
