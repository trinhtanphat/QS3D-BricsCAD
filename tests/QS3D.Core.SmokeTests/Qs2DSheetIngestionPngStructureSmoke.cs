...
namespace QS3D.Core.SmokeTests
{
    internal static class Qs2DSheetIngestionPngStructureSmoke
    {
        ...
        {
            var payload = Png(8, 2, 0, 0, 0);
            payload[33] = 0x7f; payload[34] = 0xff; payload[35] = 0xff; payload[36] = 0xff;
        ...
        {
            var start = bytes.Count; var length = data.Length;
            ...
            bytes.AddRange(data); bytes.AddRange(new byte[4]);
