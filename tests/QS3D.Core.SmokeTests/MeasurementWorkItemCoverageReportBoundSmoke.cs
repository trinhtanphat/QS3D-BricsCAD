...
namespace QS3D.Core.SmokeTests
{
    internal static class MeasurementWorkItemCoverageReportBoundSmoke
    {
        ...
        {
            var source = new DishonestReadOnlyCollection(CreateFinding(), reportedCount: 1, actualCount: MaximumFindingCount + 100);
        ...
        private sealed class DishonestReadOnlyCollection : IReadOnlyCollection<MeasurementWorkItemCoverageFinding>
        {
            ...
            public DishonestReadOnlyCollection(MeasurementWorkItemCoverageFinding finding, int reportedCount, int actualCount)
            {
                _finding = finding;
                Count = reportedCount;
