...
namespace QS3D.Core.SmokeTests
{
    internal static class FeatureFlagsCanonicalNameSmoke
    {
        ...
        private static void SnapshotIsIsolatedAndCanonical()
        {
            ...
            Throws<NotSupportedException>(() => ((IDictionary<string, bool>)snapshot).Add("Feature.B", true), "snapshot must remain read-only");
    ...
    {
        [ModuleInitializer]
        internal static void Initialize() { FeatureFlagsCanonicalNameSmoke.Run(); }
    }
}