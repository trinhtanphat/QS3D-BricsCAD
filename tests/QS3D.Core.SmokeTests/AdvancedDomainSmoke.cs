...
namespace QS3D.Core.SmokeTests
{
    internal static class AdvancedDomainSmoke
    {
        ...
        private static void StructuralOpeningDeduction()
        {
            ...
            Near(13.02, wall.Quantities["NetWallAreaM2"]); Near(2.604, wall.Quantities["NetVolumeM3"]); Near(28.30, wall.Quantities["FormworkM2"]);

            opening.Properties["SillOffsetMm"] = "500";
            new StructuralRegenerator().Regenerate(project, wall);
            Near(28.48, wall.Quantities["FormworkM2"]);
            ...
            new StructuralRegenerator().Regenerate(project, wall);
            Near(11.02, wall.Quantities["NetWallAreaM2"]); Near(2.204, wall.Quantities["NetVolumeM3"]); Near(25.48, wall.Quantities["FormworkM2"]);
            ...
            Near(13, areaOnlyWall.Quantities["NetWallAreaM2"]); Near(2.6, areaOnlyWall.Quantities["NetVolumeM3"]); Near(27.2, areaOnlyWall.Quantities["FormworkM2"]);
        }
