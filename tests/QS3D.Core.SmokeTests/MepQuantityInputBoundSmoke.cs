...
namespace QS3D.Core.SmokeTests
{
    internal static class MepQuantityInputBoundSmoke
    {
        ...
        private static void CountDriftAfterExactTraversalFailsClosed()
        {
            ...
            Equal(2, source.CountReads, "MEP Count evidence must be read before and after traversal.");
            Contains(
        ...
        private static void HonestTwoPhaseCountRemainsAccepted()
        {
            ...
            Equal(2, source.CountReads, "Stable MEP Count evidence must be rebound after traversal.");
