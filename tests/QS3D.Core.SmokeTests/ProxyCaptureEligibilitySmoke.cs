...
namespace QS3D.Core.SmokeTests
{
    internal static class ProxyCaptureEligibilitySmoke
    {
        public static void Run()
        {
            ...
            Throws<ArgumentException>(() => new EntitySnapshot("  A1  ", "Line", "blt beam"));
            var canonicalHandle = new EntitySnapshot("A1", "Line", "blt beam");
            var canonicalHandleResult = new RecognitionResult(canonicalHandle, Array.Empty<RecognitionCandidate>());
