...
namespace QS3D.Core.SmokeTests
{
    internal static class QuantityReportCompensatedAggregationSmoke
    {
        ...
        private static void PreservesAllQuantityFields()
        {
            ...
            Equal(20000000000000004d, row.GrossConcreteM3, "GrossConcreteM3 compensation drifted.");
        ...
        private static void RejectsNonFiniteAndOverflowingTotals()
        {
            ...
            Throws<ArgumentOutOfRangeException>(() => Element("nan", family, double.NaN));
        ...
        {
            element.GrossConcreteM3 = value * 2d;
