    ...
    foreach ($mode in @($default, $native, $observed)) {
        & {
            ...
            function Invoke-HostFreeNativeRunner {
                ...
                $expectedHash = if ($HostMajor -eq 25) { '8eeb3823d81eb37fbd84b652e3c7b446bc645f9edac6052afd561123aae55e82' }
                    else { '37c477d3884bab5122eb3baad9c472570213d83e7009b5572eeaabda5d6dd14e' }
                ...
                if ($PackageSha256 -cne $expectedHash -or $ProductSourceSha -cne '22b2ca9ce2ca5a1fc9522f7b5a298a6ac2f83869' -or
...
function New-NativePredecessor {
    [pscustomobject]@{
        Receipt = [pscustomobject]@{
            ...
            product_source_sha='22b2ca9ce2ca5a1fc9522f7b5a298a6ac2f83869'; phases_verified=3
        ...
        Allocation = [pscustomobject]@{
            ...
            product_source_sha='22b2ca9ce2ca5a1fc9522f7b5a298a6ac2f83869'
            package_sha256='8eeb3823d81eb37fbd84b652e3c7b446bc645f9edac6052afd561123aae55e82'
...
function Invoke-PredecessorGate($Fixture, [bool]$Native=$true) {
    ...
    $v25PackageSha256='8eeb3823d81eb37fbd84b652e3c7b446bc645f9edac6052afd561123aae55e82'
