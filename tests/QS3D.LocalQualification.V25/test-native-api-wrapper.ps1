    ...
    foreach ($mode in @($default, $native, $observed)) {
        & {
            ...
            function Invoke-HostFreeNativeRunner {
                ...
                $expectedHash = if ($HostMajor -eq 25) { '66fdae632f4c773a4343621801a1fc97ea210f7ba31f0b85048a60b9f9233423' }
                    else { '88a9446a87ca7b3ecf87410ee66907e05e5474ab26d07f173427324717b0e18a' }
                ...
                if ($PackageSha256 -cne $expectedHash -or $ProductSourceSha -cne '74dc6525b8cdb5720b1d24c7dabd2bd4ed7e63eb' -or
...
function New-NativePredecessor {
    [pscustomobject]@{
        Receipt = [pscustomobject]@{
            ...
            product_source_sha='74dc6525b8cdb5720b1d24c7dabd2bd4ed7e63eb'; phases_verified=3
        ...
        Allocation = [pscustomobject]@{
            ...
            product_source_sha='74dc6525b8cdb5720b1d24c7dabd2bd4ed7e63eb'
            package_sha256='66fdae632f4c773a4343621801a1fc97ea210f7ba31f0b85048a60b9f9233423'
