    ...
    foreach ($mode in @($default, $native, $observed)) {
        & {
            ...
            function Invoke-HostFreeNativeRunner {
                ...
                $expectedHash = if ($HostMajor -eq 25) { '918507aea148f1f784abf9c6729e8a64250948f3c74352d083f5286fcb50109f' }
                    else { '4d8cd59aadb53f3d0f6768687ce27dd27555c1f7b8a4c8e52760d17d3864ac0c' }
                ...
                if ($PackageSha256 -cne $expectedHash -or $ProductSourceSha -cne 'bb8f442d13bfc2f6cbc21bf1e0a549fd760c1608' -or
...
function New-NativePredecessor {
    [pscustomobject]@{
        Receipt = [pscustomobject]@{
            ...
            product_source_sha='bb8f442d13bfc2f6cbc21bf1e0a549fd760c1608'; phases_verified=3
        ...
        Allocation = [pscustomobject]@{
            ...
            product_source_sha='bb8f442d13bfc2f6cbc21bf1e0a549fd760c1608'
            package_sha256='918507aea148f1f784abf9c6729e8a64250948f3c74352d083f5286fcb50109f'
...
function Invoke-PredecessorGate($Fixture, [bool]$Native=$true) {
    ...
    $source='bb8f442d13bfc2f6cbc21bf1e0a549fd760c1608'
    $v25PackageSha256='918507aea148f1f784abf9c6729e8a64250948f3c74352d083f5286fcb50109f'
