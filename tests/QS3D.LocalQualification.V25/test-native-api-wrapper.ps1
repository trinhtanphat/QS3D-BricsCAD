    ...
    foreach ($mode in @($default, $native, $observed)) {
        & {
            ...
            function Invoke-HostFreeNativeRunner {
                ...
                $expectedHash = if ($HostMajor -eq 25) { '6aa178ebd1982880f1f4a5e13c6153fd2647ac9fe1ebb18fd61f2c6ebbff3845' }
                    else { '670103ca6ca7ed20749fed77acd8fe255da76fa3cd6f12702af92b7f222038f5' }
                ...
                if ($PackageSha256 -cne $expectedHash -or $ProductSourceSha -cne 'e1c2cea395db11365bdba6f113a5ba7583e88cc3' -or
...
function New-NativePredecessor {
    [pscustomobject]@{
        Receipt = [pscustomobject]@{
            ...
            product_source_sha='e1c2cea395db11365bdba6f113a5ba7583e88cc3'; phases_verified=3
        ...
        Allocation = [pscustomobject]@{
            ...
            product_source_sha='e1c2cea395db11365bdba6f113a5ba7583e88cc3'
            package_sha256='6aa178ebd1982880f1f4a5e13c6153fd2647ac9fe1ebb18fd61f2c6ebbff3845'
