...
**Branch:** `main`  
**Source reconciliation cutoff for this edition:** `b15c02c38506c332cc645dd9cbd847ae142c3146` (`docs: document native section box review commands`) plus the rebased B4D/ED2, DWG-identity and generated-geometry hardening branch documented below.  
...
- branch baseline: `origin/main` `b15c02c` plus rebased B4D/ED2 and hardening changes;
...
- all seven local `preflight*.py` scripts: PASS using BricsCAD's bundled Python 3.9;
