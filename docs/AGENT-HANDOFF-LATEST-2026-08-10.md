...
**Branch:** `main`  
**Repository/source reconciliation cutoff for this edition:** `6b9328e` (`feat(review): add transient model highlight service`) plus rebased B4D/ED2/Handle commit `b93e570` and the DWG-identity/generated-ownership hardening documented below.
...
- `6b9328e` — transient model highlight plus the preceding wall-junction/polyline-opening/rebar-shape/Room Auto/TKT/UI batch;
- `b93e570` — B4D whole-space scan and ED2 Excel/Handle round-trip rebased onto that mainline.
