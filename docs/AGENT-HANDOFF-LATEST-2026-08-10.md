...
**Branch:** `main`  
**Source reconciliation cutoff for this edition:** `3a319e60aeded680d453dcb72f22af32853ff2a8` (`feat(health): add unified generated rebar health command`) plus the rebased B4D/ED2, DWG-identity and generated-geometry hardening branch documented below.
...
- branch baseline: `origin/main` `3a319e6` plus rebased B4D/ED2 and hardening changes;
...
- all fourteen local `preflight*.py` scripts: PASS using BricsCAD's bundled Python 3.9;
