...
**Branch:** `main`  
**Repository/source reconciliation cutoff for this edition:** `a6a3f20` (`docs: include direct planar ARC room boundaries`) plus rebased B4D/ED2/Handle commit `d446f2f` and the DWG-identity/generated-ownership hardening documented below.
...
- `a6a3f20` — direct planar ARC/SPLINE Room Auto support plus the preceding TKT/physical opening/rebar-3D/UI batch;
- `d446f2f` — B4D whole-space scan and ED2 Excel/Handle round-trip rebased onto that mainline.
