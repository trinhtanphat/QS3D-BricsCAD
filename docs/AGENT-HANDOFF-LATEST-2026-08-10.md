...
**Branch:** `main`  
**Repository/source reconciliation cutoff for this edition:** `a677f03` (`test(preflight): guard room broad-phase pruning`) plus rebased B4D/ED2/Handle commit `ed0f129` and the DWG-identity/generated-ownership hardening documented below.
...
- `a677f03` — tolerance-aware Room Auto broad-phase pruning plus the preceding ARC/SPLINE/TKT/physical opening/rebar-3D/UI batch;
- `ed0f129` — B4D whole-space scan and ED2 Excel/Handle round-trip rebased onto that mainline.
