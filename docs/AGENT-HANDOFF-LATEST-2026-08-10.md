...
**Branch:** `main`  
**Repository/source reconciliation cutoff for this edition:** `b6ee4d8` (`feat(tkt): generalize line wall solids to all TKT variants`) plus rebased B4D/ED2/Handle commit `2589064` and the DWG-identity/generated-ownership hardening documented below.
...
- `b6ee4d8` — TKT line-wall variants and the preceding Room Auto/physical opening/rebar-3D/UI batch;
- `2589064` — B4D whole-space scan and ED2 Excel/Handle round-trip rebased onto that mainline.
