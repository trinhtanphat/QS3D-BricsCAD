...
**Branch:** `main`  
**Repository/source reconciliation cutoff for this edition:** `5ae8b60` (`docs: document advanced geometry and review workflows`) plus rebased B4D/ED2/Handle commit `2ee7e19` and the DWG-identity/generated-ownership hardening documented below.
...
- `5ae8b60` — advanced geometry/review documentation plus rebar shape-path 3D, scoped Room Auto identity, focus/isolate and wall-junction UI;
- `2ee7e19` — B4D whole-space scan and ED2 Excel/Handle round-trip rebased onto that mainline.
