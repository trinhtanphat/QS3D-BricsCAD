...
| LOCAL-014 | P1 / BLOCKED | P03-P06 licensed boundaries now cover advanced cancel/freshness and ownership-scoped rollback; P07 exposed source defect `#3966`, where native Undo leaves the grouped wall/Solid3d present. | After the source fix merges, rerun only bounded P07 Undo -> Redo -> QSAVE -> fresh-process reopen on a new exact clean SHA; overall qualification remains false until then. |
