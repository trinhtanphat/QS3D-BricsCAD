...
| LOCAL-008 | P1 / OPEN | `REMOTE_DONE` for quick/advanced split, preview-project/context freshness, Window/Auto Host safeguards and repeated mode source. Bounded P01 view/consecutive/cancel, P03 repeated DrawJig and P04 Door/Opening per-prompt physical-ESC cells are `LOCAL_PASS`. | Licensed project/context drift, Auto Host/reference and Ribbon/UI remainder only; do not rerun P01/P03/P04 without a material source change. |
