...
| LOCAL-006 | P1 / SOURCE_FIX_READY | #3721 licensed Semantic Tag Undo divergence returned to remote source; PR #3728 merged as `887173f28126b928765e458f28202e83a6f3b88f`. `BOUNDED_PASS / IN_PROGRESS`: on exact pushed descendant `a572ab0a350f54f8e994ac1e91f825907646af9c`, source/placement cancel, cold-cache MText build, native Undo and native Redo all preserved coherent native/property/audit/version state with Health 0. | Resume MLeader/Table/Sheet/Layout/Viewport/Unicode/HiDPI/save-reopen/multi-DWG. Do not rerun the passed bounded cell unless its source scenario materially changes. |
