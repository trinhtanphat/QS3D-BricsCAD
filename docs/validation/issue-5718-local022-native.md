...
## 2026-09-15 preview.25 R1 package/harness admission checkpoint

Protected `main` and the canonical #6189 branch were exact `74dc6525b8cdb5720b1d24c7dabd2bd4ed7e63eb` at the build, post-package and pre-TDD freshness gates. The source carries ProductVersion `0.2.0-preview.25` for V25, V26 and Core and Platform gitlink `8b0206d3b74e7bbb3c02ed71ac4c5aeef47d5efd`. Fresh stable-reference builds passed with zero warnings/errors; V26 held-host state SHA-256 is `F562BD19EA542A4F526AE7E86C6AA257E0CB507A485023BAC94FE3FF712BABC7`.

Two independent local package rounds were byte-deterministic and their expanded payload trees were identical. Exact candidate hashes: V25 ZIP `66FDAE632F4C773A4343621801A1FC97EA210F7BA31F0B85048A60B9F9233423`, V26 ZIP `88A9446A87CA7B3ECF87410EE66907E05E5474AB26D07F173427324717B0E18A`, V25 adapter `BDD21B66A1CA393A1FEC80C277A8D8B7E0FF8496D55EBCE3BD0A24D12DC1C3FA`, V26 adapter `09B6FF23FB6BFE5C5215482D2E1DCFA80C2B92EACEDB1A8CB3720BC2ACF0A29D`, shared Core `2F180F5CE11D75118CCF4B4FB6FC3AEA53D97FDD82A4D6FA6DCE87947E772A7F`. The canonical frozen pair contains 38 files.

V26 checksum/provenance generation and `assert-v26-candidate-identity.ps1` passed against release tag `v0.2.0-preview.25`, source `74dc6525b8cdb5720b1d24c7dabd2bd4ed7e63eb`, installer SHA-256 `9330806cf29e1e6b01758191aa3d9e8d301d9d3125470b6d139f78c7772f9740` and the four held host identities. Checksum-file SHA-256 is `BCDD643304E008EB2BC58C085542A539CAA58894B7BF5C7023AFA52EAA2D5D67`; provenance SHA-256 is `56057CDFAC7F764BF560E43826317C85A9EE4123F69E27B2453A11C4798BB424`, with exactly eight top-level fields and four host references.

Current-pair admission was changed by TDD: the test first failed because the V25 runner did not admit `74dc6525...`, then the minimal harness/test pin update passed. A separate terminal host-free witness passed 16/16 PowerShell regression scripts and the four canonical qualification Python preflights with zero failures; fresh exact-source-pin and sanitized-evidence Python checks also pass. Result marker SHA-256 is `87CFE5FBE12B2067C0C47D3A9D6B6D16867A3A604542A91392EC9CBB70AC39BB`. Fresh generic `scripts/preflight.py` and `git diff --check` pass. A protected-main refresh before commit still resolves exact `74dc6525b8cdb5720b1d24c7dabd2bd4ed7e63eb`. No production source file is changed by this harness carrier.

This is package/build/static admission evidence only. A fresh scan found zero allocation70 artifacts, zero BricsCAD processes and zero tunnel processes. `allocation70` remains uncreated/unconsumed. No V25 or V26 licensed runtime was executed and no `LOCAL_PASS` is claimed. The strict `38/3` per-footing and `76/3` total BQ oracle remains unchanged; V26 remains gated on a true V25 `LOCAL_PASS_BOUNDED` with three native phases and complete cleanup/restoration. Physical Quantity UI from a legitimate external computer-use channel remains required before allocation70 may be created.
