...
## 2026-09-16 preview.25 R4 package/harness admission checkpoint

- Exact protected source: `f175a6a80f1a0e9d919695622fcb5d22b7312c04`; ProductVersion `0.2.0-preview.25`; Platform gitlink `8b0206d3b74e7bbb3c02ed71ac4c5aeef47d5efd`.
- R3 is superseded before commit/push because #7227 changed `src/QS3D.BricsCAD.V25/CurvedStructuralLifecycleRuntimeProbeCommands.cs`. Its aggregate also recorded an external-orchestration timeout plus end-of-budget V26 provenance timeout, but neither result can salvage stale R3 identity.
- Fresh R4 V25/V26 stable-reference builds both succeed with 0 warnings / 0 errors. The pre-init V25 failure is retained as workspace-setup evidence only: the new worktree had an empty `external/QS3D-Platform`; initializing the exact gitlink fixed the unchanged-source build.
- Deterministic two-pass pair: V25 ZIP `B6E964FC88142D10A6F837DEF48C6E08A9B6D2DD2889042C761DD18836329DAC`; V26 ZIP `732C84AB8D79D6F82C3D132AB2405B45ADE3DF83CCCF51D6AE1210B702FE9242`; V25 adapter `F4A793EF3EF57DFF7180EA9A9FCE36AF57E4483DCE6E374BC22C3933A2DC42AD`; V26 adapter `98DEE4D4A11D7E05924E5A4A2C722AC5E0AA1475891410B9A6ABADC367179061`; shared Core `C9D3563EEABFB8E42327A5C89860F77B44B28778B996E5916C5970179134310D`. Pass1/pass2 manifests match and base expanded payload is 36/36 byte-identical.
- Frozen pass2 adds only publication evidence, yielding 38 files: checksum-file SHA `2BC5ABF9804325DCCE49B94465311292A477E7B833B2E2020A7C55D6C7A89834`; provenance SHA `E50FBACDD4A341161EF514EBE91234D09118C1F8CC5A8D023595AC41A9FE2C14`; host-state SHA `F562BD19EA542A4F526AE7E86C6AA257E0CB507A485023BAC94FE3FF712BABC7`. Provenance has 8 top-level fields, 4 host references, exact source/version/tag/package identity, and installer authority `9330806cf29e1e6b01758191aa3d9e8d301d9d3125470b6d139f78c7772f9740`. `assert-v26-candidate-identity.ps1` passes independently.
- TDD witness: stale/current-pair expectation RED exit 1 before runner pinning; after minimal harness-only pinning, `test-current-pair-admission.ps1` and `test-native-api-wrapper.ps1` both exit 0. No production source is modified.
- Focused pre-doc witness PASS: 16/16 PowerShell tests, 6/6 local-qualification Python guards, generic `scripts/preflight.py`, PowerShell AST and `git diff --check`; exact `HEAD == origin/main == f175a6a8...`, BricsCAD=0, tunnel executables=0, allocation71 artifacts=0. Witness SHA `27647A4812FD40E7FD4CC34E6A979836BD0F3B4DDB033FA8CFC0F873E7156435`.
- Standalone reproductions of the two R3 aggregate timeout gates pass on R4: `preflight-external-orchestration-aliases.py` and `preflight-v26-provenance-unique-identity.py`. Full aggregate still must pass on the final 7-path R4 tree before commit.
- Historical allocation70 is consumed `FAIL_OR_NO_RESULT` and may never be replayed. Allocation71 is the next eligible licensed identity but remains uncreated. Static/build/package/CI evidence is not `LOCAL_PASS`; physical Quantity UI is mandatory before V25 licensed execution, and V26 stays blocked until true V25 `LOCAL_PASS_BOUNDED` (`phases_verified=3`) plus exact cleanup/restoration.

## 2026-09-16 preview.25 R5 exact-current carrier checkpoint

- Carrier base: `1740823dbd44ace4a940e978fc0b17254d583b86`. Frozen package source remains `f175a6a80f1a0e9d919695622fcb5d22b7312c04` because #7230 changes only the two curved-lifecycle harness scripts and introduces zero product/package-relevant drift.
- Reuse the already verified deterministic pair without rebuild/refreeze: V25 `B6E964FC88142D10A6F837DEF48C6E08A9B6D2DD2889042C761DD18836329DAC`; V26 `732C84AB8D79D6F82C3D132AB2405B45ADE3DF83CCCF51D6AE1210B702FE9242`; shared Core `C9D3563EEABFB8E42327A5C89860F77B44B28778B996E5916C5970179134310D`.
- R5 replays only the same seven reserved paths. Its own final focused suite, exclusive full aggregate, fresh protected-main check and exact-head CI are required before any commit/runtime admission.
- Historical allocation70 remains consumed `FAIL_OR_NO_RESULT`; allocation71 remains uncreated. Static/build/package/CI evidence is not `LOCAL_PASS`; physical Quantity UI remains mandatory and V26 remains blocked until true V25 `LOCAL_PASS_BOUNDED` with `phases_verified=3` plus cleanup/restoration.

## 2026-09-16 preview.25 R6 carrier / aggregate triage checkpoint
- Exact carrier base: 4be1f86d95b319397a41365c83cbcd4430d08a46; frozen package/product source remains `f175a6a80f1a0e9d919695622fcb5d22b7312c04` because R5->R6 protected-main drift changes only V26 held-upload/release preflight orchestration and no product/package payload path.
- R6 replays the exact 7 reserved files; all 5 executable harness/test files are byte-identical to R5/R4, preserving V25 ZIP B6E964FC88142D10A6F837DEF48C6E08A9B6D2DD2889042C761DD18836329DAC, V26 ZIP 732C84AB8D79D6F82C3D132AB2405B45ADE3DF83CCCF51D6AE1210B702FE9242, and shared Core C9D3563EEABFB8E42327A5C89860F77B44B28778B996E5916C5970179134310D.
- Detached R4 aggregate terminal evidence: EXIT=1, log SHA 5DD08EC0428B2CD77B9A6FD0F13D9B7FF153F5E2FA1F1D9B356567456C4607C5; real failures were V25 release-cleanup adversarial harness timeout at 120s and aggregate budget exhaustion before V26 finalizer. Both pass standalone on R6 with unchanged policy: cleanup 26.171s / SHA 4ED3EE7C8BB48802414C77C46AD74AD011BFBF1125262AFFAAB8AFCE833A35BF; finalizer 3.929s / SHA 97FADD4B900C86B5455F66EF5D160A6764A9139579991849F3A54935067D5BB6.
- R6 full aggregate terminal evidence: EXIT=1 on exact HEAD==MAIN 4be1f86d95b319397a41365c83cbcd4430d08a46, log SHA BD6C84C174CEBD997FB539764C5C29A07C817FC25EB7CDACDFF9CA32C60A68F7. Its only real failure was preflight-v26-held-assembly-version.py aggregate-timeout with about 14.172s remaining after 1867 launched gate headers. The same gate passes standalone on unchanged R6 source; evidence log SHA 2E8631531952B4A26DF8648D85EFE1CF08F0930875D201639DEBF77CE34BAF2B. No timeout/budget was increased or bypassed.
- Full aggregate still must pass on final R6 tree. Allocation71 remains absent; physical Quantity UI and zero-host/tunnel state remain mandatory before licensed V25, and V26 remains blocked until true bounded V25 PASS plus cleanup/restoration.
## 2026-09-16 preview.25 R7 product refreeze / harness checkpoint
- Exact product/carrier source: `22b2ca9ce2ca5a1fc9522f7b5a298a6ac2f83869`; ProductVersion `0.2.0-preview.25`; Platform gitlink `8b0206d3b74e7bbb3c02ed71ac4c5aeef47d5efd`. R6 was superseded because #7223 adds production Core source `src/QS3D.Core/Commercial/ConstructionLifecycleWorkflow.cs`, so R7 rebuilds/refreezes rather than inheriting the R4 binaries.
- Fresh official stable-reference build pipeline is GREEN for V25 and V26 with 0 warnings / 0 errors. V25 log SHA: `CA998590C5AE7E829456A82783DFD32E8958A28A3752BF022F55BB62D4B9247B`; V26 log SHA: `75F49CD8F0D2CCD1FDC5AA1E9165A8729EFF386172D126F9F0803F4562ADC422`; V26 host-reference state SHA: `F562BD19EA542A4F526AE7E86C6AA257E0CB507A485023BAC94FE3FF712BABC7`.
- Two complete package rounds match byte-for-byte across the base 36-file pair. V25 ZIP `8EEB3823D81EB37FBD84B652E3C7B446BC645F9EDAC6052AFD561123AAE55E82`; V26 ZIP `37C477D3884BAB5122EB3BAAD9C472570213D83E7009B5572EEAABDA5D6DD14E`; V25 adapter `0663F5DFEC4395C6607094FAB08C8FFD0097BD2BBA9E686C480B108CB021C8AC`; V26 adapter `19CB6EB1719E9E82E047DD3D78E671840676C320E18CEBFF6B9686EDE7782ABC`; shared Core `8FDA4E8C5B475DA39256C0380F99CB092DB94DBB3A8C65BB17584D916CD995EB`; mismatch count zero.
- The interrupted first pass2 attempt is not a verdict. The clean resume verified the pre-existing V26 ZIP was the preserved pass1 hash before deleting only that owned `dist` output, then official `package-v26.ps1` reproduced the same V26 ZIP and the final 36/36 comparison passed.
- Frozen pass2 publication evidence: checksum SHA `26BCB1A6041A58624AE01055CA5A617FF6DB30CEB2AC51B73FA269B74266CE03`; provenance SHA `67A3C06C409E5394A812644F15698FB09DB9D9D77F8ED5E4142B7C684EAE325E`; 8 top-level fields, 4 exact installed-host refs, source/package identity above, installer authority `9330806cf29e1e6b01758191aa3d9e8d301d9d3125470b6d139f78c7772f9740`. Independent candidate identity assertion passes.
- TDD: an R7-expectation copy of `test-current-pair-admission.ps1` fails exit 1 against the stale harness; after replaying the reviewed R6 harness logic and changing only source/V25/V26 package pins to R7, `test-current-pair-admission.ps1` and `test-native-api-wrapper.ps1` both exit 0.
- The final R7 focused suite and full aggregate still must pass before commit/push. Allocation71 remains absent; no build/package/CI evidence is `LOCAL_PASS`, and licensed V25/V26 execution remains gated by the issue's physical UI and predecessor rules.
## 2026-09-16 preview.25 R8 exact-current carrier checkpoint
- R8 carrier base is exact protected main 5e1aa08037aa855aab0d85cdcc23dd71dd602edb. Drift from R7 base 22b2ca9ce2ca5a1fc9522f7b5a298a6ac2f83869 is smoke-test-only (tests/QS3D.Core.SmokeTests/QsQuantBimWorkbenchStateSmoke.cs and tests/QS3D.Core.SmokeTests/QuantBimStandaloneCompositionSmoke.cs), with zero product/package-relevant path changes, so the frozen product source remains 22b2ca9ce2ca5a1fc9522f7b5a298a6ac2f83869.
- Frozen deterministic pair remains V25 8EEB3823D81EB37FBD84B652E3C7B446BC645F9EDAC6052AFD561123AAE55E82, V26 37C477D3884BAB5122EB3BAAD9C472570213D83E7009B5572EEAABDA5D6DD14E, V25 adapter 0663F5DFEC4395C6607094FAB08C8FFD0097BD2BBA9E686C480B108CB021C8AC, V26 adapter 19CB6EB1719E9E82E047DD3D78E671840676C320E18CEBFF6B9686EDE7782ABC, shared Core 8FDA4E8C5B475DA39256C0380F99CB092DB94DBB3A8C65BB17584D916CD995EB.
- R7 focused and exclusive-zero-host evidence passed, but its full aggregate became invalid for admission after the host lost the canonical repository path and global dotnet resolution during the run; the aggregate recorded environment/tool-resolution failures, child timeouts, and final budget exhaustion. No timeout/budget was increased and no failure was relabeled PASS.
- R8 replays exactly the seven reserved paths from an immutable R7 backup manifest SHA F54D6E4CF363E841FA1F2C358993113ECE5A43491034AEE527F472939ADC8622; Platform is pinned to 8b0206d3b74e7bbb3c02ed71ac4c5aeef47d5efd. R8 host-free/aggregate gates are still pending.
- Global dotnet resolution is absent, but exact .NET SDK 8.0.425 bytes are available under C:\QS3D-Runtime\LOCAL003\_toolchain_ephemeral_8.0.425\dotnet; R8 validation may pin that toolchain only in the child process PATH without changing machine-wide configuration.
- allocation71 remains uncreated. Static/build/package/CI evidence is not LOCAL_PASS; licensed V25 still requires legitimate physical Quantity UI plus zero-host/tunnel protected state, and V26 remains blocked until true V25 LOCAL_PASS_BOUNDED with phases_verified=3 and cleanup/restoration.

## 2026-09-17 preview.25 R9 product refreeze / harness checkpoint
- Exact carrier/product source bb8f442d13bfc2f6cbc21bf1e0a549fd760c1608; ProductVersion 0.2.0-preview.25; Platform 8b0206d3b74e7bbb3c02ed71ac4c5aeef47d5efd.
- Stable-reference builds PASS and deterministic package comparison is 36/36 byte-identical, mismatch zero. V25 ZIP 918507AEA148F1F784ABF9C6729E8A64250948F3C74352D083F5286FCB50109F; V26 ZIP 4D8CD59AADB53F3D0F6768687CE27DD27555C1F7B8A4C8E52760D17D3864AC0C.
- Candidate identity PASS with checksum B58A653FDA1CF7F4A6127344B7BD56B87ADBAC054D48AAD2F197D1C718FE5D99 and provenance 275DD595950CDBDEF9A3E8DECAB41E4D5029C17782EAEAD618A9B9B4E52B003A. TDD RED(1) -> GREEN(0/0). No LOCAL_PASS is claimed.
