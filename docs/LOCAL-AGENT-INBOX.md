...
- Evidence: PENDING_LOCAL
- Related docs: `docs/SEMANTIC-TAGS.md`; `docs/COMMANDS-NATIVE-DOCUMENTATION-TABLES.md`; `docs/DOCUMENTATION-LAYER.md`; `docs/EXISTING-PROJECT-MUTATION-CONTEXT.md`; `scripts/preflight-semantic-tag-project-lifecycle.py`; `docs/LOCAL-AGENT-CONTINUE-ALL-2026-08-10.md`
- Updated: 2026-08-11
