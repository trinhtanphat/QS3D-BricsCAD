...
- The integrated branch based on `origin/main` `3a319e6` compiled Core and the BricsCAD V25 adapter against the installed V25.2.10 managed assemblies in Release/x64 with **0 warnings / 0 errors**.
- The deterministic Core smoke executable reported `ALL PASS`.
- All fourteen repository `preflight*.py` scripts passed using the installed BricsCAD Python 3.9 runtime. No GitHub Action was dispatched.
