...
- signed-package finalization revalidates `QS3D / BricsCAD V25 x64`, metadata AssemblyVersion/productVersion and exact plugin/Core managed identities after executable signature verification and before mutating metadata, regenerating hashes or rebuilding the release ZIP;
