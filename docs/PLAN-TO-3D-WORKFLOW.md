...
<<<<<<< HEAD
Exact BricsCAD V25 proof cho project xuất hiện/thay project, Model Space/UCS thay đổi, source bị sửa/xóa/chuyển loại và ownership-scoped compensation nằm trong **LOCAL-014** của `docs/LOCAL-AGENT-INBOX.md`; source review không được coi là `LOCAL_PASS`.
=======
