...
4. valid-host, no-host and ambiguous-host outcomes;
5. Ribbon/Domain Hub primary buttons still launch the quick commands;
6. schedule/XLSX/Locate and explicit selected-opening physical cut continue to see the created semantic objects normally;
7. multi-DWG/document-switch protection and save/reopen behavior.
