...
- Baseline main SHA: `2723f3d69cf1fd0e7837696e241f13fd8c754ae0`
- Resumed: 2026-08-21 (UTC+7), after the prior no-HWND host-activation
  prerequisite and after current `main` integrated the offline-WPF and slabOpen
  Undo source corrections that require fresh licensed reruns.
