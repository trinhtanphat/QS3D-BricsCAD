...
Live bounding boxes confirmed the intended wall/neighbor placement, and the semantic Column capture completed. The independent native intersection proves that the two disposable solids overlap and that the V25 boolean kernel can calculate their intersection. Production refresh nevertheless published `ConcreteContactAreaM2=0`.
