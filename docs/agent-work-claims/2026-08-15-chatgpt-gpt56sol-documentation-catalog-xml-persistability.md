...
Implementation/regression are fully represented by PR #1502 against the owner-authorized integration-v2 branch. No session-only source change remains. Claim stays ACTIVE until coordinator import/release.
