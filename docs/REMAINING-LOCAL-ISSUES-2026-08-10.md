...
- **#83 — generalized polygonal Slab/Foundation mesh.** Core clipping/planning may advance remotely, but native generated bars must be proven to stay inside real host boundaries/openings while preserving cover, faces, independent directions, ownership, stale and health semantics.
