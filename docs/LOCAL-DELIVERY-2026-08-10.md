...
- Reconciled remote baseline: `b15c02c` (`docs: document native section box review commands`).
- Rebased B4D/ED2 commit: `d593cae` (`feat: add B4D scan and Excel handle round-trip`).
...
- All ten repository `preflight*.py` scripts: PASS.
