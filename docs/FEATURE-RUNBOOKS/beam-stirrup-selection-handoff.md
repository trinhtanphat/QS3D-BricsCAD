...
6. Existing project snapshot rollback, generated-rebar ownership checks, native transaction commit ordering and post-commit UI warning semantics remain unchanged.
